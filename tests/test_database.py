...
from clickhouse.fields import DateField, Float32Field, StringField
...
data = [
    ...
    {"first_name": "Dominiq", "last_name": "Sando", "birthday": "1972-02-01", "height": "1.72"},
    ...
    {"first_name": "Whilemin", "last_name": "Blanken", "birthday": "1970-07-14", "height": "1.66"},
